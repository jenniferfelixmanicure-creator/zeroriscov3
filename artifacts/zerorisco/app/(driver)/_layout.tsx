...
export default function DriverLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="earnings" options={{ title: "Ganhos", tabBarIcon: ({ color, size }) => <Feather name="dollar-sign" size={size} color={color} /> }} />
      <Tabs.Screen name="history" options={{ title: "Histórico", tabBarIcon: ({ color, size }) => <Feather name="clock" size={size} color={color} /> }} />
