import http from "http";
  ...
  async function seedCategoriesIfEmpty() {
    try {
      ...
      logger.info("✅ 4 categorias iniciais criadas (Moto, Básico, Intermediário, VIP)");
    } catch (err) {
      logger.warn({ err }, "Seed de categorias ignorado — tabela ainda não existe ou já populada");
    }
  }
